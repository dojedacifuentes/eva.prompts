...
════════════════════════════════════════════════════════
 EVA LAB · Prompt Lab · Prompting jurídico
...
export function generateCompact(fullPrompt: string): string {
  ...
  return `[PROMPT COMPACTO — EVA LAB · Prompt Lab]\n\n${core.join('\n')}`;
}
...
export function generatePromptPlusPlus(
  ...
  return `# EVA LAB Architect — Structured Machine-Readable Format
# EVA LAB · Prompt Lab · Prompting jurídico
...
//  EVA Cognitive IR · Multi-Model Compiler Engine
// ════════════════════════════════════════════════════════════════════════════
...
<!--
  EVA Cognitive Runtime v3.0 · Compilado para Claude
  EVA LAB · Prompt Lab · Prompting jurídico
-->
...
[EVA LAB · Cognitive Runtime v3.0 · Prompt Lab]
...
*EVA LAB · Prompt Lab · Prompting jurídico · "Construye criterio antes de automatizar."*`;
}
