...
// nada más.
// ─────────────────────────────────────────────────────────────────────────────
import { STAGES, type StageId } from '@/content/curso/etapas';
import { compilePrompt } from '@/content/curso/lab';
...
export function stageProgress(state: CursoState, id: StageId): StageProgress {
...
export interface CursoProgress {
...
export function computeProgress(state: CursoState): CursoProgress {
