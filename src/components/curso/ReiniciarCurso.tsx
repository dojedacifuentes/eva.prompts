...
// explícita ese bloqueo se convierte en un callejón —no se puede repetir el
// curso, y un equipo compartido arrastra el trabajo de quien lo usó antes—, y
// desde fuera parece que el botón está roto.
//
...
export function ReiniciarCurso({ onReset }: { onReset?: () => void }) {
  const { reset } = useCurso();
  ...
  return (
    <div className="rounded-xl border border-rose-500/30 bg-rose-500/[0.07] px-3.5 py-3">
      <p className="text-xs leading-relaxed text-rose-200">
        ...
        descargado tu documento de trabajo, hazlo antes.
      </p>
