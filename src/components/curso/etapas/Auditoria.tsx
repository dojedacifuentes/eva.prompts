...
// propio, con delimitadores— y dos decisiones que obligan a distinguir
// auditar de obedecer.
// ─────────────────────────────────────────────────────────────────────────────
import { useEffect } from 'react';
import Link from 'next/link';
import { METAPROMPT_AUDITORIA } from '@/content/curso/prompts';
 ...
 * prompt real sin tener que explicar nada más.
 */
...
export function Auditoria() {
  ...
  // es tuyo y nada lo vuelve a pisar.
  useEffect(() => {
  ...
  if (hydrated && !promptV1) {
    return (
      <Notice tone="warn">
        ...
        <Link href="/curso/prompt" className="underline underline-offset-2">Vuelve a construirlo</Link>.
      </Notice>
    );
  }
    ...
    <>
      ...
      <div className="space-y-3">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <DownloadButton
            onClick={() => downloadText(promptV2, 'mi-prompt-v2.txt')}
