...
// clasificación epistémica A–E: el objetivo es experimentar el
// procedimiento, no que memorice cinco códigos.
// ─────────────────────────────────────────────────────────────────────────────
import Link from 'next/link';
import { Plus, Trash2 } from 'lucide-react';
import { claimActions, type ClaimAction } from '@/content/curso/actividades';
import { useCurso } from '@/lib/curso/store';
import { emptyClaim, type VerifiedClaim } from '@/lib/curso/estado';
        ...
        {hydrated && !prompt && (
          <div className="mt-3">
            <Notice tone="warn">
              ...
              <Link href="/curso/prompt" className="underline underline-offset-2">Constrúyelo aquí</Link>.
            </Notice>
          </div>
        )}
      </Panel>
