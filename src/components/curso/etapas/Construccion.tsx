'use client';
// ─────────────────────────────────────────────────────────────────────────────
// ETAPA 2 · CONSTRUCCIÓN DEL PROMPT
//
// El corazón del curso. Se construye un encargo apretando botones y escribiendo
// muy poco. El prompt se escribe solo debajo, en tiempo real, y lo que se copia
// se ejecuta: sin marcadores, sin etiquetas por rellenar, con su propio
// material dentro.
//
...
export function Construccion() {
  const { state, update, hydrated } = useCurso();
  ...
  // Una edición manual manda sobre el compilador: si se tocó el
            ...
            <PromptBlock
              ...
              actions={
                <>
                  ...
                  <DownloadButton onClick={() => downloadText(promptText, 'mi-prompt-v1.txt')} />
                </>
              }
              note={
                compiled.warning ? (
