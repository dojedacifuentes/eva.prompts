...
// descarga. Nada de esto se puntúa: el valor está en hacer visible el
// desplazamiento del razonamiento entre la primera respuesta y la última.
// ─────────────────────────────────────────────────────────────────────────────
import Link from 'next/link';
import {
  blameOptions, blameQuestion, confidenceLevels,
  type BlameOption, type ConfidenceLevel,
} from '@/content/curso/actividades';
    ...
    <>
      {hydrated && !before.committed && (
        <Notice tone="warn">
          ...
          <Link href="/curso" className="underline underline-offset-2">Volver al principio</Link>.
        </Notice>
      )}
