// ─────────────────────────────────────────────────────────────────────────────
// CURSO · CONTENIDO DE LAS ACTIVIDADES
//
// La interfaz no contiene texto pedagógico propio: si algo se enseña, vive
// aquí. Así el contenido se puede revisar, discutir y reemplazar sin tocar un
// solo componente.
// ─────────────────────────────────────────────────────────────────────────────
...
/**
 * Ficha bibliográfica falsa: el caso con el que abre el curso.
 *
 * El autor es un marcador deliberado. Atribuir una obra inexistente a una
 * persona real e identificable, en un material que circula por internet, no es
 * aceptable ni siquiera como ejercicio.
 */
...
/** Tabla de referencia de la línea disciplinaria chilena. */
...
// ─── LOS SIETE COMPONENTES DEL ENCARGO ───────────────────────────────────────
...
export interface PromptComponent {
  ...
  ifMissing: string;
  whenOmit: string;
  /** Fuentes y Control son los dos que el prompting genérico suele omitir. */
  signature?: boolean;
}

export const promptComponents: readonly PromptComponent[] = [
  {
    id: 'contexto',
    label: 'Contexto',
...
/** Las siete instrucciones de control. */
...
/**
 * Prompt de diagnóstico: el ejemplo de riesgo medio que se somete a análisis.
 * Deliberadamente vago, para que se vea qué decide el modelo cuando quien
 * escribe no decide. Sustituible por uno propio.
 */
...
/** Rúbrica de autoevaluación del prompt. */
export const rubric = [
...
/** Mini banco de errores frecuentes. */
...
/** Siete señales de alerta en una respuesta de IA. */
...
export const groundingDecisions: readonly GroundingDecision[] = [
  {
    id: 'g1',
    scenario:
      'Una herramienta acompaña cada afirmación con un localizador. Abres uno y el fragmento carga correctamente en diez segundos.',
