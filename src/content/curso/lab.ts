// ─────────────────────────────────────────────────────────────────────────────
// CURSO · LABORATORIO DE LA ETAPA 2
//
// Catálogo de decisiones y compilador de prompts.
//
// Regla dura del compilador: lo que sale de aquí se pega en un modelo y la
// tarea empieza. Sin marcadores, sin etiquetas por rellenar, sin instrucciones
// dirigidas a la persona mezcladas con instrucciones dirigidas al modelo. Si
// falta un dato imprescindible, no se exporta: se dice qué falta.
//
// Los siete componentes del encargo están detrás de la interfaz como preguntas,
// no como casillas obligatorias. Rol vive en «Agregar extras» porque no toda
// tarea lo necesita: esa ausencia es contenido pedagógico, no un olvido.
// ─────────────────────────────────────────────────────────────────────────────
